...
function [GRF_average, max_GRF, flexion_angles, max_flexion, flexion_moments, max_moment, MF_average, max_MF_average]=TrialAveragePerSubject_Jan14(freq,subjectID,brace,task,trial,plotY)

close all
% Example: [GRF_average, max_GRF, flexion_angles, max_flexion, flexion_moments, max_moment, MF_average, max_MF_average]=TrialAveragePerSubject_Jan14(20,2,1,7,[1 4],1)
%          
% 
