...
AvgMFMax=[1.453 1.51 5.134 1.371 4.771];
AvgMFBraceMax=[1.749 1.731 5.729 1.438 4.628];

StdErrMFMax=[0.142 0.168 0.245 0.088 0.224];
StdErrMFBraceMax=[0.141 0.167 0.244 0.087 0.223];

barwitherr([StdErrMFMax' StdErrMFBraceMax'],[AvgMFMax' AvgMFBraceMax'], 'LineWidth',2,...
    'BarWidth',0.9)  %BAR PLOT
% errorbar([0.9, 1.9, 2.9, 3.9, 4.9], AvgMFMax, StdErrMFMax, 'o'); %SCATTER
% PLOT
hold on;
% errorbar([1.1, 2.1, 3.1, 4.1, 5.1],AvgMFBraceMax, StdErrMFBraceMax, 'o', 'MarkerEdgeColor','r')
