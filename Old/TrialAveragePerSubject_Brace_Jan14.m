...
function [GRF_average, max_GRF, flexion_angles, max_flexion, flexion_moments, max_moment, MF_average, max_MF_average]=TrialAveragePerSubject_Brace_Jan14(freq,subjectID,brace,task,trial,plotY)
close all;
% Example: [GRF_average, max_GRF, flexion_angles, max_flexion, flexion_moments, max_moment, MF_average, max_MF_average]=TrialAveragePerSubject_Brace_Jan14(20,3,2,7,[2 3 4],1)
%           
