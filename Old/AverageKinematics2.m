...
function [MFdata MFmean IniTime EndTime b index]=AverageKinematics2(freq,subjectID,brace,task,trial, plotY)
...
% 
% 
% Ouputs:   freq = frequency of kinetic filter 
%                 i.e. freq=[15 20 30 40 50 60 80 100]
% 
%           subjectID = subject ID number
%
...
IK_final=zeros(200,3);
ID_final=zeros(200,3);
