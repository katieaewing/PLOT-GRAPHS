...
function [GRF_average, max_GRF, flexion_angles, max_flexion, flexion_moments, max_moment, MF_average, max_MF_average]=TrialAveragePerSubject_June14(freq,subjectID,brace,task,trial,plotY)

close all
% Example: [GRF_average, max_GRF, flexion_angles, max_flexion, flexion_moments, max_moment, MF_average, max_MF_average]=TrialAveragePerSubject_June14(20,2,1,7,[1 4],1)
%          
% 
...
%     legend('GRF','HAMS', 'VAS', 'RF','GAS','GMAX','ILPSO','SOL','TA');
    legend('Ground Reaction Force','Hamstrings', 'Vasti', 'Rectus Femoris','Gastrocnemius','Gluteus Maximus','Iliopsoas','Soleus','Tibialis Anterior');
...
%     hNewAxes = axes('Position',axesPosition,'YLim',[0 max(MF_average_BW(:,2))*1.7],'Color','none','YAxisLocation','right', 'XTick',[],'Box','off');  
    ...
    title(['NO BRACE'], 'fontsize', 18,'fontweight','bold');
