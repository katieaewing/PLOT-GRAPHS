...
function [GRF_average, flexion_angles, flexion_moments, MF_average]=TrialAveragePerSubject_Brace(freq,subjectID,brace,task,trial,plotY)

% Example: [GRF_average, flexion_angles, flexion_moments, MF_average]=TrialAveragePerSubject(20,1,1,7,[2 3 4],1)
%          [GRF_average, flexion_angles, flexion_moments, MF_average]=TrialAveragePerSubject(20,1,1,5,3,1)
%           [GRF_average, flexion_angles, flexion_moments, MF_average]=TrialAveragePerSubject_Brace(20,1,2,7,4,1)
...
for x=task
    ...
    for y=trial
        DirTask=[DirBrace '\Brace_' task_label{x} '_' int2str(y)];
        cd(DirTask);
...
%FOR TESTING ONE TRIAL AT A TIME
for i=1:size(MF,2)
...
%     title('Stop Jump - Average of Three Trials', 'fontsize', 14);
%     saveas(figure(1),'SJ_average_GRF','jpg');
...
%     title('Stop Jump - Average of Three Trials', 'fontsize', 14);
%     saveas(figure(2),'SJ_average_flexion','jpg');
...
%     xlabel('Percent Landing Phase','fontsize',fontsize);
    ...
    axis([0 100 0 max(MF_average(:,2))*1.2]);
%     title('Stop Jump - Average of Three Trials', 'fontsize', 14);
%     saveas(figure(3),'SJ_average_MF','jpg');
...
%     xlabel('Percent Landing Phase','fontsize',fontsize);
    ...
    axis([0 100 0 max(MF_average(:,2))*1.2]);
%     title('Stop Jump - Average of Three Trials', 'fontsize', 14);
%     saveas(figure(4),'SJ_average_MF_GRF','jpg');
